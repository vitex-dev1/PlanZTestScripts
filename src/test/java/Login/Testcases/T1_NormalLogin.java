...
public class T1_NormalLogin extends TestSetup {
    ...
    public T1_NormalLogin(ExcelHelper excelHelper) {
    ...
    public void checkCorrectPage() {
        BrowserManager.getDriver().get(PropertiesHelper.getValue("LOGIN_URL"));
        Actions.assertContains(Actions.getCurrentUrl(), "/plans/sign_in", "FAIL. Not at Login");
    }

    @Test(priority = 2)
    public void loginSuccess() {

        Actions.openURL(PropertiesHelper.getValue("LOGIN_URL"));
        Login.adminLogin(excelHelper.getCellData(1,1), excelHelper.getCellData(2,1));
