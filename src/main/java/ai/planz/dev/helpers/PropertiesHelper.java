...
import java.util.Properties;
    ...
    public class PropertiesHelper {
        ...
        public static Properties loadAllFiles() {
            ...
            // Add Properties here following the template
...
//        files.add("src/test/resources/configs/production.properties");
        ...
        public static String getValue(String key) {
            ...
            try {
                ...
                // Retrieve the value from the file that has been set.
        ...
        public static void setValue(String key, String keyValue) {
            try {
                ...
                //Write to the same Prop file as the file retrieved
                out = new FileOutputStream(linkFile);
                WriteLogs.info(linkFile);
